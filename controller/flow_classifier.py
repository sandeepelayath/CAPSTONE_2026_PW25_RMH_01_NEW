...
class FlowClassifier:
    ...
    def __init__(self, 
                 model_path='../finetuned_ML_model_stored/lstm_model_combined.keras', 
                 scaler_path='../finetuned_ML_model_stored/scaler.pkl', 
                 features_path='../finetuned_ML_model_stored/feature_names.pkl'):
        """
