...
def run_tests(net):
    ...
    info("🔴 h6 performing ARP spoofing\n")
    simulate_attack(h6, h2.IP(), "arp_spoof")
    simulate_attack(h6, h2.IP(), "brute_force")

    # 3️⃣ Brute-force SSH simulation from h5
    ...
    # 5️⃣ Honeypot probing from h6 and h8
    info("🧠 h6 and h8 contacting honeypot (h9)\n")
    simulate_attack(h6, h9.IP(), "honeypot_probe")
